...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='photo2davidmckee_fpn_gan_v2', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--checkpoints_dir', type=str, default='/media/test/Samhi/fpn-gan/checkpoints', help='models are saved here')
        ...
        parser.add_argument('--netG', type=str, default='resnet_fpn', help='selects model to use for netG')

...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', required=False, default="./dataset/cityscapes_cycle_orj", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--fpn_weights', type=list, default=[1.0, 0.5, 0.5, 0.5], help='weights for each fpn layer from C5 to C2')
